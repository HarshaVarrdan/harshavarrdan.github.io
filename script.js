...
var SearchPlaces = ["Search near Bag Rack", "Search near Conference Hall Notice Board","Search near Opposite to Digital Reading Room Flags","Search near Below Quadrangle Staircase","Meet us in Computer Lab", ];

document.addEventListener("DOMContentLoaded", function () {
    const params = new URLSearchParams(window.location.search);
    let riddleNumber = params.get("riddle");
